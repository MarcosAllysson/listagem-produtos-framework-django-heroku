...
SECRET_KEY = 'django-insecure-qn*(9k@bnwc)tif+uu9!%x+((+$tm_o#m3x1!ajsdea3a+3=cr'
...
# verificações do django sobre as requisições recebidas
MIDDLEWARE = [
...
# ao fazer logout da página de admin, redireciona para o index
